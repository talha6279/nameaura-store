...
<table class="table table-bordered table-striped table-responsive col-12">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('product.restore', $products->item_id) }}" class="btn btn-sm btn-primary">Restore</a>
            </td>
            <td>
                <a href="{{ route('product.permdeleted', $products->item_id) }}" class="btn btn-sm btn-danger">Delete</a>
            </td>
        </tr>
